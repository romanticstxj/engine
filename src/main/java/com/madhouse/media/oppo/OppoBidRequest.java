...
public class OppoBidRequest {
    ...
    private Integer test = 0;//标识测试模式1：测试 0：正式
    private Integer at = 2;//拍卖类型1:First Price;2:Second Price Plus
    ...
    public class Imp {
        ...
        /**
         * 曝光类型标记，在验证请求参数时设置，避免反复通过native和pmp对象，判断曝光类型，造成过长的判断语句和重复的判断逻辑
         */
        ...
        public class Native {
            ...
            /**
             * 用来存放request字段中json数据转换的对象，避免多次json转换
             */
            private OppoNativeRequest nativeObj;
            ...
            public OppoNativeRequest getNativeObj() {
                return nativeObj;
            }

            public void setNativeObj(OppoNativeRequest nativeObj) {
